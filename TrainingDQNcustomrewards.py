...
model = DQN("MlpPolicy", env1, policy_kwargs=cnn, verbose=1, tensorboard_log="./dqn_tensorboardcustomrewards/", learning_rate=0.00001, exploration_fraction=0.5, exploration_initial_eps= 1, exploration_final_eps=0.6)
